...
class UPApplications(unittest.TestCase):
    def setUp(self):
    ...
    def test_up_applications(self):
        ...
        self.up_mongo_ms(driver)
        self.up_callother_ms(driver)
        driver.close()

    def up_mongo_ms(self, driver):
    ...
    def up_callother_ms(self, driver):
