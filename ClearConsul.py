...
class ClearConsul(unittest.TestCase):
    def setUp(self):
    ...
    def delete_config(self, driver):
        driver.find_element_by_link_text("Key/Value").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Applications'])[1]/following::label[1]").click()
        driver.find_element_by_link_text("Delete").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Applications'])[1]/following::button[1]").click()
